...
BEGIN {
    ...
    require '/Users/venkateshpulimamidi/qudosslwork/qudossl-commercial/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/venkateshpulimamidi/qudosslwork/qudossl-commercial/openssl/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = '/Users/venkateshpulimamidi/qudosslwork/qudossl-commercial/openssl/test/default-and-jitter.cnf';
    shift;
